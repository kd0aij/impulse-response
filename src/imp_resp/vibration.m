...
if false
  ...
  a0t = data.timestamp / 1e6;
  accel0 = [data.x_integral data.y_integral data.z_integral] ./ data.integral_dt;
  #accel0 = [data.x data.y data.z];

  filename = [basePath prefix "sensor_combined_0.csv"];
  printf ("input file: %s\n", filename);

  cdata = tdfread(filename);
  a0t = cdata.timestamp / 1e6;
  accel0 = [cdata.accelerometer_m_s2_0_ cdata.accelerometer_m_s2_1_ cdata.accelerometer_m_s2_2_];
  #accel0 = [data.x data.y data.z];
endif
